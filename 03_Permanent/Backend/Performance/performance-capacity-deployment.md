...
aliases: [Performance Capacity Deployment, Capacity-Based Rollout, Performance Testing Deployment, Load Testing Deployment]
promoted_from: fl-2026-06-03-performance-capacity-deployment
related: []
---
...
- [[llm-observability-setup]] — AI 서비스에 성능 기반 배포 적용 시 연동되는 모니터링 셋업
