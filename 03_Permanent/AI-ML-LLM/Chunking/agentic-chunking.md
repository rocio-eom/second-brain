...
promoted_from: fl-2026-06-03-chunking-strategy-agentic
related:
  - "[[fixed-size-chunking]]"
  - "[[recursive-chunking]]"
  - "[[semantic-chunking]]"
...
- [[semantic-chunking]] — 임베딩 거리 기반 경계. agentic이 LLM으로 한 단계 더 적극화한 형태
- [[recursive-chunking]] — agentic 대비 baseline. A/B로 항상 함께 평가
- [[document-structured-chunking]] — 형식 기반 결정론. agentic이 형식 감지·전략 선택을 자동화한 일반화
- [[fixed-size-chunking]] — agentic의 정반대 극. 결정론·저비용 vs 적응·고비용
- [[sliding-window-chunking]] — proposition 단위 + sentence-window retrieval로 정밀도 극대화 결합
