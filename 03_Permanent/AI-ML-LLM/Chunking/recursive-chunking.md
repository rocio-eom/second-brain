...
promoted_from: fl-2026-06-03-chunking-strategy-recursive
related:
  - "[[fixed-size-chunking]]"
  - "[[semantic-chunking]]"
...
- [[fixed-size-chunking]] — recursive의 베이스라인. 결정론성·예측성 동등하지만 자연 경계는 무시
- [[semantic-chunking]] — 임베딩 거리 경계. recursive의 모델-비의존 장점을 비용으로 트레이드
- [[document-structured-chunking]] — 마크다운·HTML·코드에서 recursive 대체. 구조 마커가 있을 때 우선
- [[sliding-window-chunking]] — recursive의 overlap을 정밀화하거나 retrieval 단계에서 보강
- [[agentic-chunking]] — recursive의 정반대. LLM이 문서별 전략을 적응 선택
