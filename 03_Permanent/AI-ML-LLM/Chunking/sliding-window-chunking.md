...
promoted_from: fl-2026-06-03-chunking-strategy-sliding-window
related:
  - "[[fixed-size-chunking]]"
  - "[[recursive-chunking]]"
  - "[[semantic-chunking]]"
...
# Sliding Window / Sentence-window Chunking
...
- [[fixed-size-chunking]] — overlap 변형은 fixed-size의 경계 손실을 보완하는 가장 단순한 적용
- [[recursive-chunking]] — sentence-window의 sentence splitting 단계와 recursive의 자연 경계 결합 가능
- [[semantic-chunking]] — sentence-window는 retrieval 단계 분리, semantic은 청킹 단계 분리 — 결합 가능
- [[document-structured-chunking]] — 구조 청크 + sentence-window retrieval로 인용 정확도 극대화
- [[agentic-chunking]] — proposition 단위 + sentence-window 결합 시 검색 정밀도 최고. 비용도 최고
