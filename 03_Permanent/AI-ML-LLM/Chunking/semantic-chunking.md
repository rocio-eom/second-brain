...
promoted_from: fl-2026-06-03-chunking-strategy-semantic
related:
  - "[[fixed-size-chunking]]"
  - "[[recursive-chunking]]"
...
- [[recursive-chunking]] — semantic의 베이스라인. 비용 0에 결정론적이지만 의미 경계는 못 봄
- [[fixed-size-chunking]] — semantic이 해결하려는 의미 단절 한계의 원점
- [[agentic-chunking]] — semantic이 임베딩 거리에 의존하는 반면 agentic은 LLM 판단으로 더 적극 분할
- [[sliding-window-chunking]] — semantic 청크 + sentence-window retrieval 결합 패턴
- [[document-structured-chunking]] — semantic 대신 헤딩 hierarchy를 직접 사용하는 형식 기반 대안
