...
promoted_from: fl-2026-06-03-chunking-strategy-fixed-size
related:
  - "[[recursive-chunking]]"
  - "[[semantic-chunking]]"
...
- [[recursive-chunking]] — 일반 텍스트의 디폴트. fixed의 결정론성을 유지하면서 자연 경계를 추가로 존중
- [[semantic-chunking]] — 임베딩 거리 기반 경계. fixed의 의미 단절 한계를 비용으로 해결
- [[sliding-window-chunking]] — overlap의 정밀화. fixed의 경계 손실 보완 패턴
- [[document-structured-chunking]] — 마크다운·HTML·코드에서 fixed 대체
- [[agentic-chunking]] — LLM 기반 적응 분할. fixed와 정반대 극의 비결정성/고비용 전략
