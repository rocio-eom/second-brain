...
domain: ai-ml-llm
moc: "[[moc-llm-serving]]"
tags: [ai-observability, llm-monitoring, mlops, observability, sre, opentelemetry]
aliases: [AI Service Monitoring, LLM Observability, AI Observability]
promoted_from: fl-2026-06-03-ai-service-monitoring-setup
related: []
---

# LLM 서비스 모니터링 (AI Observability)
...
> **2026년 6월 기준**. 도구별 기능·포지셔닝은 1-2년 내 변동 가능. 정기 갱신 권장.
...
- [OpenTelemetry GenAI Semantic Conventions Specification (opentelemetry.io)](https://opentelemetry.io/docs/specs/semconv/gen-ai/) — GenAI SIG 공식 spec. gen_ai.* attribute 정의의 1차 출처
...
- [OpenLLMetry GitHub (Traceloop)](https://github.com/traceloop/openllmetry) — 본문 언급 자동 instrumentation 라이브러리 공식 소스코드 및 문서

## 관련 노트

- [[fl-2026-06-03-performance-capacity-deployment]] — LLM 서빙 성능·용량 계획 (승격 대기 fleeting)
- [[moc-llm-serving]] — LLM Serving MOC
