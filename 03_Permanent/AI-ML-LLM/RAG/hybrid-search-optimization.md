...
promoted_from: fl-2026-06-02-hybrid-search-optimization
related: []
---
...
- [[embedding-vector-index-coupling]] — RAG retrieval layer: embedding × vector index 결합도·4축 트레이드오프
- [[recall-vs-filter-tradeoff]] — vector search에서 recall과 metadata filter 간 트레이드오프
- [[vector-store-decision-matrix]] — hybrid search 지원 여부를 포함한 벡터 저장소 선택 매트릭스
